...
public class OrbitMonitorModuleBeanInfo extends SimpleBeanInfo {
  ...
  static {
    try {
      ...
      properties[PROPERTY_distanceFractionDigits] = new PropertyDescriptor ( "distanceFractionDigits", OrbitMonitorModule.class, "getDistanceFractionDigits", "setDistanceFractionDigits" );
    }
