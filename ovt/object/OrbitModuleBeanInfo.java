...
public class OrbitModuleBeanInfo extends SimpleBeanInfo {
  ...
  static {
    try {
      properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", OrbitModule.class, "isVisible", "setVisible" );
      properties[PROPERTY_color] = new PropertyDescriptor ( "color", OrbitModule.class, "getColor", "setColor" );
    }
