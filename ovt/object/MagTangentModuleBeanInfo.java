...
public class MagTangentModuleBeanInfo extends SimpleBeanInfo {
  ...
  static {
    try {
      properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", MagTangentModule.class, "isVisible", "setVisible" );
      properties[PROPERTY_color] = new PropertyDescriptor ( "color", MagTangentModule.class, "getColor", "setColor" );
    }
