...
public class FieldlineModuleBeanInfo extends SimpleBeanInfo {
  ...
  static {
    try {
      properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", FieldlineModule.class, "isVisible", "setVisible" );
    }
