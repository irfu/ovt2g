...
public class FieldlineDataModuleBeanInfo extends SimpleBeanInfo {
  ...
  static {
    try {
      properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", FieldlineDataModule.class, "isVisible", "setVisible" );
    }
